...
func Load(l loader.Loader, content []byte) (K8sPolicies, JSONPolicies, AuthzPolicies, error) {
	...
	for _, object := range untyped {
		...
		case policyV1, policyV2:
			...
			if err != nil {
				return k8sPolicies, jsonPolicies, authzPolicies, fmt.Errorf("failed to convert policy: %w", err)
			}
		...
		case clusterPolicyV1, clusterPolicyV2:
			...
			if err != nil {
				return k8sPolicies, jsonPolicies, authzPolicies, fmt.Errorf("failed to convert cluster policy: %w", err)
			}
			k8sPolicies.Policies = append(k8sPolicies.Policies, typed)
		case vapV1, vapV1beta1:
			typed, err := convert.To[v1.ValidatingAdmissionPolicy](object)
			if err != nil {
				return k8sPolicies, jsonPolicies, authzPolicies, fmt.Errorf("failed to convert vap: %w", err)
			}
		...
		case vapbV1, vapbV1beta1:
			...
			if err != nil {
				return k8sPolicies, jsonPolicies, authzPolicies, fmt.Errorf("failed to convert vapb: %w", err)
			}
		...
		case vpolV1alpha1, vpolV1beta1, vpolV1:
			...
			if err != nil {
				return k8sPolicies, jsonPolicies, authzPolicies, fmt.Errorf("failed to convert vpol: %w", err)
			}
		...
		case nvpolV1beta1, nvpolV1:
			...
			if err != nil {
				return k8sPolicies, jsonPolicies, authzPolicies, fmt.Errorf("failed to convert nvpol: %w", err)
			}
			mode := EvaluationMode(typed.Spec.EvaluationMode())
		...
		case ivpolV1alpha1, ivpolV1beta1, ivpolV1:
			...
			if err != nil {
				return k8sPolicies, jsonPolicies, authzPolicies, fmt.Errorf("failed to convert ivpol: %w", err)
			}
			mode := EvaluationMode(typed.Spec.EvaluationMode())
		...
		case nivpolV1beta1, nivpolV1:
			...
			if err != nil {
				return k8sPolicies, jsonPolicies, authzPolicies, fmt.Errorf("failed to convert nivpol: %w", err)
			}
			mode := EvaluationMode(typed.Spec.EvaluationMode())
		...
		case dpolV1alpha1, dpolV1beta1, dpolV1:
			...
			if err != nil {
				return k8sPolicies, jsonPolicies, authzPolicies, fmt.Errorf("failed to convert dpol: %w", err)
			}
		...
		case ndpolV1beta1, ndpolV1:
			...
			if err != nil {
				return k8sPolicies, jsonPolicies, authzPolicies, fmt.Errorf("failed to convert ndpol: %w", err)
			}
			k8sPolicies.DeletingPolicies = append(k8sPolicies.DeletingPolicies, typed)
		case gpolV1alpha1, gpolV1beta1, gpolV1:
			typed, err := convert.To[policiesv1beta1.GeneratingPolicy](object)
			if err != nil {
				return k8sPolicies, jsonPolicies, authzPolicies, fmt.Errorf("failed to convert gpol: %w", err)
			}
		...
		case mpolV1alpha1, mpolV1beta1, mpolV1:
			...
			if err != nil {
				return k8sPolicies, jsonPolicies, authzPolicies, fmt.Errorf("failed to convert mpol: %w", err)
			}
			mode := EvaluationMode(typed.Spec.EvaluationMode())
