  ...
  <v-app-bar flat border>
    ...
    <div class="app-logo">
      <template v-if="display.mdAndUp.value">
        ...
        <v-chip size="small" style="position: absolute; bottom: 12px; right: -80px">v1.12</v-chip>
      </template>
      <template v-if="display.smAndDown.value">
        <v-img src="/favicon.png" width="80" />
        <v-chip size="small" style="position: absolute; bottom: 16px; left: 80px">Kyverno v1.12</v-chip>
      </template>
    </div>
